...
//					update new photo
		...
		public String signup(Model model) {
			model.addAttribute("title", "Register - Employeeportalapp");
		...
		//public void getInfoByPath(@RequestParam String role,Model model) {
			// List<User> list=userRepository.findByRole(role);

		// putting the name and email in the database spring_db
		//creating path value for the url by replacing \ with %5C
